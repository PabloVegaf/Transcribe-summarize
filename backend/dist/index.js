 ...
 */
function processJob(jobId, filePath, action, apiKey) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (action === 'summarize_short' || action === 'summarize_long') {
                const summary = yield generateSummary(cleanTranscription, action, openai);
                jobs[jobId] = {
                    status: 'completed',
                    data: {
                        action,
 ...
 */
function generateSummary(transcription, action, openai) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d;
        const prompts = {
        ...
        try {
            ...
            const summary = (_d = (_c = (_b = (_a = response.choices) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content) === null || _d === void 0 ? void 0 : _d.trim();
